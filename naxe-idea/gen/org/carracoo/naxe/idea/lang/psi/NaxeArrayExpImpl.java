...
public class NaxeArrayExpImpl extends NaxeExpImpl implements NaxeArrayExp {

  public NaxeArrayExpImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof NaxeVisitor) ((NaxeVisitor)visitor).visitArrayExp(this);
