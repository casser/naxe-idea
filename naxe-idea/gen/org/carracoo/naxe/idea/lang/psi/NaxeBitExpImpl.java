...
public class NaxeBitExpImpl extends NaxeBinaryExpImpl implements NaxeBitExp {

  public NaxeBitExpImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof NaxeVisitor) ((NaxeVisitor)visitor).visitBitExp(this);
