...
public class NaxeBshExpImpl extends NaxeBinaryExpImpl implements NaxeBshExp {

  public NaxeBshExpImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof NaxeVisitor) ((NaxeVisitor)visitor).visitBshExp(this);
