...
public class NaxeCallArgImpl extends NaxePsiElementImpl implements NaxeCallArg {

  public NaxeCallArgImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof NaxeVisitor) ((NaxeVisitor)visitor).visitCallArg(this);
