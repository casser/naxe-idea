...
public class NaxeElvExpImpl extends NaxeExpImpl implements NaxeElvExp {

  public NaxeElvExpImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof NaxeVisitor) ((NaxeVisitor)visitor).visitElvExp(this);
