...
public class NaxeForExpImpl extends NaxeExpImpl implements NaxeForExp {

  public NaxeForExpImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof NaxeVisitor) ((NaxeVisitor)visitor).visitForExp(this);
