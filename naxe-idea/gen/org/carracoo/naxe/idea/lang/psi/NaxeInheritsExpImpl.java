...
public class NaxeInheritsExpImpl extends NaxeExpImpl implements NaxeInheritsExp {

  public NaxeInheritsExpImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof NaxeVisitor) ((NaxeVisitor)visitor).visitInheritsExp(this);
