...
public class NaxeMulExpImpl extends NaxeBinaryExpImpl implements NaxeMulExp {

  public NaxeMulExpImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof NaxeVisitor) ((NaxeVisitor)visitor).visitMulExp(this);
