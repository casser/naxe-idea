...
public class NaxeNewExpImpl extends NaxeExpImpl implements NaxeNewExp {

  public NaxeNewExpImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof NaxeVisitor) ((NaxeVisitor)visitor).visitNewExp(this);
