...
public class NaxeObjectPairImpl extends NaxePsiElementImpl implements NaxeObjectPair {

  public NaxeObjectPairImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof NaxeVisitor) ((NaxeVisitor)visitor).visitObjectPair(this);
  ...
  public NaxeIdentifier getIdentifier() {
    return findChildByClass(NaxeIdentifier.class);
  }
