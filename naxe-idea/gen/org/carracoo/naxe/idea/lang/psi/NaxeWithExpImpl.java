...
public class NaxeWithExpImpl extends NaxeExpImpl implements NaxeWithExp {

  public NaxeWithExpImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof NaxeVisitor) ((NaxeVisitor)visitor).visitWithExp(this);
